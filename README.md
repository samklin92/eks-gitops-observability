...
| **aws-finops-detective** | Cross-account cost analytics, anomaly detection, and orphaned resource discovery (extends the original AWS Cost Detective repo) |
...
| **aws-finops-detective** *(code + tests complete, not yet deployed)* | Cross-account cost analysis, anomaly detection, and orphaned resource scanning powered by the observability platform and cross-account IAM architecture |
